...
namespace Editor_Base_Class {
    partial class Gen2Editor {
        ...
        protected const int
                ...
                TR_CLASS_NAME_I = 22, TR_CLASS_NAME_END_I = 23, TR_CLASS_DV_I = 24, TR_CLASS_ATTRIBUTE_I = 25,
        ...
        protected void initOffsets(int[] oTL, int[] oTS) {
            ...
            foreach (int offset_i in offsetsToLoad) {
                loadOffset[offset_i] = true;
            }
            foreach (int offset_i in oTS) {
                saveOffset[offset_i] = true;
            }
        }
    }
}